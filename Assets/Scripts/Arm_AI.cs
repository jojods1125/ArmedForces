...
//    {
//        // Set up arm loadouts
//        if (armType == ArmSide.Front) FrontArmInitialize();
...
//            // Update UI
//            if (uiManager) uiManager.ui_Players[0].UpdateSelectedUI(armType, weaponLetters[weapon]);
//        }
//    }
...
//                if (uiManager) uiManager.UpdateAmmoUI(armType, 'A', ammoRemaining[weaponA], weapon.ammoCapacity, player.GetPlayerID());
//            }

//            else if (equippedWeapon.Equals(weaponB))
//            {
//                ammoRemaining[weaponB] = Mathf.Min(ammoRemaining[weaponB] + count, weapon.ammoCapacity);
//                if (uiManager) uiManager.UpdateAmmoUI(armType, 'B', ammoRemaining[weaponB], weapon.ammoCapacity, player.GetPlayerID());
//            }

//            else if (equippedWeapon.Equals(weaponC))
//            {
//                ammoRemaining[weaponC] = Mathf.Min(ammoRemaining[weaponC] + count, weapon.ammoCapacity);
//                if (uiManager) uiManager.UpdateAmmoUI(armType, 'C', ammoRemaining[weaponC], weapon.ammoCapacity, player.GetPlayerID());
//            }

//            else if (equippedWeapon.Equals(weaponD))
//            {
//                ammoRemaining[weaponD] = Mathf.Min(ammoRemaining[weaponD] + count, weapon.ammoCapacity);
//                if (uiManager) uiManager.UpdateAmmoUI(armType, 'D', ammoRemaining[weaponD], weapon.ammoCapacity, player.GetPlayerID());
//            }
